...
/**
 * Standalone unit bootstrap for module-catalog.
 *
...
$autoloadCandidates = [
    __DIR__ . '/../../../../../autoload.php',           // vendor/mage-obsidian/module-catalog/src/Test/Unit -> vendor/autoload.php
